function meta = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   META = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   META = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   meta = importfile('1-meta.txt', 5, 25);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/12/08 11:23:18
