...
clear trainingDataLing trainingData

trainingData = metaInputs;
trainingDataLing(1,:) = metaInputs(11,:);
trainingDataLing(2,:) = metaInputs(12,:);
trainingDataLing(3,:) = metaInputs(15,:);
trainingDataLing(4,:) = metaInputs(20,:);
clear metaInputs metaTargets
